...
ylim_EP <- range(whole_e.coli_EP_forward)*1.1
boxplot(c(whole_e.coli_EP_forward, whole_e.coli_EP_reverse), main = 'E. coli whole genome: EP', ylim = ylim_EP)
boxplot(c(whole_synechocystis_EP_forward, whole_synechocystis_EP_reverse), main = 'Synechocystis sp. whole genome: EP', ylim = ylim_EP)
boxplot(c(whole_mycoplasma_EP_forward, whole_mycoplasma_EP_reverse), main = 'Mycoplasma whole genome: EP', ylim = ylim_EP)

boxplot(c(whole_e.coli_dynchars_forward$d, whole_e.coli_dynchars_reverse$d), main = 'E. coli whole genome: d')
boxplot(c(whole_e.coli_dynchars_forward$gc, whole_e.coli_dynchars_reverse$gc), main = 'E. coli whole genome: GC')
