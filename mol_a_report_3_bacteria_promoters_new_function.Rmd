...
for (i in 1:length(exp_tsss)) {
  if (exp_strands[i]=='forward') {
    ...
    E01forward<-rbind(E01forward, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'forward')$E0)
    d1forward<-rbind(d1forward, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'forward')$d)
    GCforward<-rbind(E01forward, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'forward')$gc)
   
    EPforward <- rbind(EPforward, 
                       calculate_EP_on_interval(extended_string = e.coli_U00096.2_char, tss_position = exp_tsss[i], ep_interval = c(350, 150), strand = 'forward' ))
    
     } else {
    seqsreverse<- c(seqsreverse, strReverse(substr(e.coli_U00096.2, start = exp_tsss[i] - 50, stop = exp_tsss[i] + 150))) #intervals for reverse strand are different
     E01reverse<-rbind(E01reverse, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'reverse')$E0)
    d1reverse<-rbind(d1reverse, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'reverse')$d)
    GCreverse<-rbind(E01reverse, dynchars(seq = e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = exp_tsss[i], boundaries = c(150, 50), strand = 'reverse')$gc)
   
    EPreverse <- rbind(EPreverse, 
                       calculate_EP_on_interval(extended_string = e.coli_U00096.2_char, tss_position = exp_tsss[i], ep_interval = c(350, 150), strand = 'reverse' ))
...
for (i in 1:length(exp_tsss)) {
  if (synechocystis_proms[i]=='forward') {
     synechocystis_seqsforward <- c(synechocystis_seqsforward, substr(synechocystis_NC_000911.1, start = synechocystis_proms[i] - 150, stop = synechocystis_proms[i] + 50))
     
    synechocystis_E01forward<-rbind(synechocystis_E01forward, dynchars(seq = synechocystis_NC_000911.1_char, average_interval_size = average_interval_size, tss = synechocystis_proms[i], boundaries = c(150, 50), strand = 'forward')$E0)
    synechocystis_d1forward<-rbind(synechocystis_d1forward, dynchars(seq = synechocystis_NC_000911.1_char, average_interval_size = average_interval_size, tss = synechocystis_proms[i], boundaries = c(150, 50), strand = 'forward')$d)
    synechocystis_GCforward<-rbind(synechocystis_GCforward, dynchars(seq = synechocystis_NC_000911.1_char, average_interval_size = average_interval_size, tss = synechocystis_proms[i], boundaries = c(150, 50), strand = 'forward')$gc)
   
    synechocystis_EPforward <- rbind(synechocystis_EPforward, 
                       calculate_EP_on_interval(extended_string = synec, tss_position = exp_tsss[i], ep_interval = c(350, 150), strand = 'forward' ))
    
     } else {
  synechocystis_seqsreverse<- c(synechocystis_seqsreverse, strReverse(substr(synechocystis_NC_000911.1, start = synechocystis_proms[i] - 50, stop = synechocystis_proms[i] + 150))) #intervals for reverse strand are different
...
#plot(seq_along(mycoplasma_CP006916.3_char), type = 'n', main = 'Mycoplasma gallisepticum promoters location', xlab = 'Sequence (nts)', yaxt = 'n', bty = 'n', asp = 1)
...
for (i in 1:length(mycoplasma_proms$Position)) {
  if (mycoplasma_proms$Strand[i]=='1') {
     mycoplasma_seqsforward <- c(mycoplasma_seqsforward, substr(mycoplasma_CP006916.3, start = mycoplasma_proms$Position[i] - 150, stop = mycoplasma_proms$Position[i] + 50))
     
    mycoplasma_E01forward<-rbind(mycoplasma_E01forward, dynchars(seq = mycoplasma_CP006916.3_char, average_interval_size = average_interval_size, tss = mycoplasma_proms$Position[i], boundaries = c(150, 50), strand = 'forward')$E0)
    mycoplasma_d1forward<-rbind(mycoplasma_d1forward, dynchars(seq = mycoplasma_CP006916.3_char, average_interval_size = average_interval_size, tss = mycoplasma_proms$Position[i], boundaries = c(150, 50), strand = 'forward')$d)
    mycoplasma_GCforward<-rbind(mycoplasma_GCforward, dynchars(seq = mycoplasma_CP006916.3_char, average_interval_size = average_interval_size, tss = mycoplasma_proms$Position[i], boundaries = c(150, 50), strand = 'forward')$gc)
   
    mycoplasma_EPforward <- rbind(mycoplasma_EPforward, 
                       calculate_EP_on_interval(extended_string = synec, tss_position = exp_tsss[i], ep_interval = c(350, 150), strand = 'forward' ))
    
     } else {
  mycoplasma_seqsreverse<- c(mycoplasma_seqsreverse, strReverse(substr(mycoplasma_CP006916.3_char, start = mycoplasma_proms$Position[i] - 50, stop = mycoplasma_proms$Position[i] + 150))) #intervals for reverse strand are different
    ...
    mycoplasma_EPforward <- rbind(mycoplasma_EPforward, 
                       calculate_EP_on_interval(extended_string = mycoplasma_CP006916.3_char, tss_position = exp_tsss[i], ep_interval = c(350, 150), strand = 'forward' ))
