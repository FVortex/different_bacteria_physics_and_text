...
cut_char_vec(vec_seq, tss, boundaries, strand)

  # strand <- match.arg(strand)


calculate_EP_on_interval(tss_position = 1000, extended_string = vec_seq, ep_interval = c(10, 10))


calculate_profile(dnaSeq = (strsplit('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaccccccccccccccccccccccccccccccccccccccccccccc', split = '')[[1]]), average_interval_size = 30, dynamic_interval = c(10, 30), tss_position = 50, ep_interval = 30)
