...
whole_e.coli_dynchars_forward <- dynchars(e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = length(e.coli_U00096.2_char) , boundaries = c(0,  length(e.coli_U00096.2_char)), strand = 'forward')

whole_e.coli_dynchars_reverse <- dynchars(e.coli_U00096.2_char, average_interval_size = average_interval_size, tss = length(e.coli_U00096.2_char)/2 , boundaries = c(100,  length(e.coli_U00096.2_char) - 100), strand = 'reverse')#!

str(whole_e.coli_dynchars_forward)

whole_e.coli_EP_forward <- calculate_EP_on_interval(extended_string = e.coli_U00096.2,tss_position = length(e.coli_U00096.2_char)/2, ep_interval = c(1, nchar(e.coli_U00096.2)), strand = 'forward')

whole_e.coli_EP_reverse <- calculate_EP_on_interval(extended_string = e.coli_U00096.2,tss_position = length(e.coli_U00096.2_char)/2, ep_interval = c(1, nchar(e.coli_U00096.2)), strand = 'reverse')
...
Check-up for reverse strand. All sequences on reverse strand in spline_dataset_pro.Rdata replacement
