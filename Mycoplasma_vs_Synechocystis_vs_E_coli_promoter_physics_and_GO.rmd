...
```{r Clusterization for separate bacteria}

ward_e.coli_E01 <- hclust.vector(E01, method = 'ward')

plot(ward_e.coli_E01, labels = F)

cuplcl(E01, method = 'ward', k = 4)
```
...
cuplcl(E01, method = 'ward', k = 4)
cuplcl(synechocystis_E01, method = 'ward', k = 4)
cuplcl(mycoplasma_E01, method = 'ward', k = 4)
...
cuplcl(EP, method = 'ward', k = 4)
cuplcl(synechocystis_EP, method = 'ward', k = 4)
cuplcl(mycoplasma_EP, method = 'ward', k = 4)
...
cuplcl(GC, method = 'ward', k = 4)
cuplcl(synechocystis_GC, method = 'ward', k = 4)
cuplcl(mycoplasma_GC, method = 'ward', k = 4)
