...
```{r Does sequence type and genome-wide SIDD maxima overlap?}
...
TUSet <- read.table('/home/jane/Документы/Misha/mol_a_2018/different_bacteria_physics_an_text/regulondb_TUSet_html_line_removed.txt', header = F, sep = '\t')
```


```{r GO enrichment using clusterProfiler}
...
genes_formula <- compareCluster(Entrez~group, data=random_df, fun='enrichGO', OrgDb='org.EcK12.eg.db')
