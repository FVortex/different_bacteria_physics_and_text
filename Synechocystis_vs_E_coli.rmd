...
for (i in list(synechocystis_seqs, seqs, e.coli_U00096.2, synechocystis_NC_000911.1)){
  print(length(i))
...
colnames(all_seqs_oligos_freq) <- c('Synechocystis promoters', 'E. coli promoters', 'E. coli', 'Synechocystis')
...
PCA <- prcomp(all_seqs_oligos_freq[,c(2,3)], scale = T)
#library(factoextra)
#fviz_pca_biplot(PCA12, col.var = 2, labelsize = 0.8)+ggtitle('PCA result on hexamers occurences')
