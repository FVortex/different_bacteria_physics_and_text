...
for (i in c('E01', 'd1', 'GC', 'EP')){
  ...
  to_plot_wards <- c(to_plot_wards, to_plot_ward_both_tmp)
}
...
```{r Tanglegrams, cache=T}

labels(to_plot_wards[[1]]) <- labels(to_plot_wards[[2]])
tg12 <- tanglegram(dend1 = to_plot_wards[[1]], to_plot_wards[[2]], intersecting =T, lwd = 0.3 )
untangle(tanglegram(dend1 = to_plot_wards[[1]], to_plot_wards[[2]], intersecting =T, lwd = 0.3 ))
```
