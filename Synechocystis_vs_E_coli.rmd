...
```{r Overall characteristics for both bacteria, cache=T}
...
```{r E. coli promoters physics, cache=T} 
...
Creating matrices of dynamical properties and GC-content for intervals [-150; 50] nts
```{r Synechocystis proms physics, cache=T} 
...
dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-150):(synechocystis_proms$`1 TSS`[i]+50)], interval_size = interval_size)$E01)                       
    synechocystis_d1forward<-rbind(synechocystis_d1forward, dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-150):(synechocystis_proms$`1 TSS`[i]+50)], interval_size = interval_size)$d1)                       
    #aeos4forward<-rbind(aeos4forward, matr1[(as.numeric(exp_proms[i,3])-150):(as.numeric(exp_proms[i,3])+50),4])            
    synechocystis_GCforward<-rbind(synechocystis_GCforward, dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-150):(synechocystis_proms$`1 TSS`[i]+50)], interval_size = interval_size)$gc1)                       
    
    p<-lseqspline1D(substr(synechocystis_NC_000911.1, synechocystis_proms$`1 TSS`[i]-250, synechocystis_proms$`1 TSS`[i]+150), bound=c(50, 350), ref=251 )
...
dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-50):(synechocystis_proms$`1 TSS`[i]+150)], interval_size = interval_size)$E01)                       
    synechocystis_d1reverse<-rbind(synechocystis_d1reverse, dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-50):(synechocystis_proms$`1 TSS`[i]+150)], interval_size = interval_size)$d1)                       
    #aeos4reverse<-rbind(aeos4reverse, matr1[(as.numeric(exp_proms[i,3])-150):(as.numeric(exp_proms[i,3])+50),4])            
    synechocystis_GCreverse<-rbind(synechocystis_GCreverse, dynchars(synechocystis_NC_000911.1_char[(synechocystis_proms$`1 TSS`[i]-50):(synechocystis_proms$`1 TSS`[i]+150)], interval_size = interval_size)$gc1)                       
    
    p<-lseqspline1D(substr(synechocystis_NC_000911.1, synechocystis_proms$`1 TSS`[i]-150, synechocystis_proms$`1 TSS`[i]+250), bound=c(50, 350), ref=251 )
