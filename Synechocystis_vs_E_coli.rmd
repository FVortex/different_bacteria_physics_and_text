...
```{r CHecking bimodality for SIDD fro all promoters}

sums_sidds_ecoli <- apply(sidds_ecoli[,-1], 2, function(x) {sum(x[750:2250])})

sums_sidds_syn <- apply(sidds_syn[,-1], 2, function(x) {sum(x[750:2250])})
