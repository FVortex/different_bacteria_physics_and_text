...
for (i in list(synechocystis_seqs, seqs)){
  print(length(i))
...
colnames(all_seqs_oligos_freq) <- c('Synechocystis promoters', 'E. coli promoters')
...
PCA12 <- prcomp(all_seqs_oligos_freq[,1:2], scale = T)
#library(factoextra)
