...
#labels(to_plot_ward_both_tmp) <- labels(to_plot_ward_synechocystis_e.coli_proms_stringdist)
#tg <- tanglegram(dend1 = to_plot_ward_both_tmp, to_plot_ward_synechocystis_e.coli_proms_stringdist, intersecting =T)
#plot(tg)
```
