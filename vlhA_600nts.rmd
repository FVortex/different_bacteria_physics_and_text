...
```{r All the vlhA}
vlha_600 <- read.fasta('/home/jane/Документы/Misha/mol_a_2018/new_different_bacteria_physics_an_text /vlhA_600nts.fasta', seqonly = F, as.string = T)
length(vlha_600)
str(vlha_600)
...
regexpr(pattern='[^(gaa)](gaa){3}[^(gaa)]', text = 'hjhjhjgaagaagaahjhjgaaaaaaahj')
